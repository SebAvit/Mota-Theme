...
const menuContactHeader = document.querySelector(
    ".header__menu__desktop .page-item-83 a"
);
// Link Contact Menu Mobile
const menuContactMobile = document.querySelector(
    ".header__menu__mobile .page-item-83 a"
);
...
if (contactButton) {
    contactButton.addEventListener('click', prefillReferenceInput);
}
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const accueilLink = document.querySelector(".header__menu__desktop .page-item-77 a");
